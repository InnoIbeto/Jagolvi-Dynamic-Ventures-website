  ...
  return (
    <main className="container py-5">
      ...
      <div className="row align-items-center index-row-2 mx-0 mb-5">
        <div className="col-lg-5 mb-4 mb-lg-0 px-md-5 text-start">
          ...
          <div id="carouselExampleAutoplaying" className="carousel slide shadow-lg rounded-4 overflow-hidden" data-bs-ride="carousel">
            <div className="carousel-inner bg-white">
              <div className="carousel-item active p-5">
                <img src="/images/images/Tata Logo.png" className="d-block w-100 mx-auto" alt="Tata Logo" style={{ maxHeight: '300px', objectFit: 'contain' }} />
              </div>
              <div className="carousel-item p-5">
                <img src="/images/images/Yutong Logo.png" className="d-block w-100 mx-auto" alt="Yutong Logo" style={{ maxHeight: '300px', objectFit: 'contain' }} />
              </div>
              <div className="carousel-item p-5">
                <img src="/images/images/Ashok_Leyland Logo.png" className="d-block w-100 mx-auto" alt="Ashok Leyland Logo" style={{ maxHeight: '300px', objectFit: 'contain' }} />
              </div>
              <div className="carousel-item p-5">
                <img src="/images/images/mercedes benz logo.png" className="d-block w-100 mx-auto" alt="Mercedes" style={{ maxHeight: '300px', objectFit: 'contain' }} />
              </div>
              <div className="carousel-item p-5">
                <img src="/images/images/Cummins Logo.png" className="d-block w-100 mx-auto" alt="Cummins" style={{ maxHeight: '300px', objectFit: 'contain' }} />
              </div>
            </div>
